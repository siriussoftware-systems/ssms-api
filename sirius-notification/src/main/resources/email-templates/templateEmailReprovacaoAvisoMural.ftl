    ...
    <td bgcolor="#ffffff">
      ...
      <tbody>
        ...
        <td>
         ...
         <p> Como o(a) sr(a). &eacute; APROVADOR(A) do departamento ${departamento}, gostar&iacute;amos de avis&aacute;-lo(a) que o aviso foi REPROVADO.</strong> </p>         
         <p>
           <font color="#B51714" face="Arial, Helvetica, sans-serif">
             Abaixo est&atilde;o sendo enviados um RESUMO das informa&ccedil;&otilde;es do aviso REPROVADO:
           </font>
          </p>
