    ...
    <td bgcolor="#ffffff">
      ...
      <tbody>
        ...
        <td>
         ...
         <p> Como o(a) sr(a). &eacute; LIBERADOR(A) do departamento ${departamento}, gostar&iacute;amos de avis&aacute;-lo(a) que o aviso N&Atilde;O FOI LIBERADO.</strong> </p>         
         <p>
           <font color="#B51714" face="Arial, Helvetica, sans-serif">
             Abaixo est&atilde;o sendo enviados um RESUMO das informa&ccedil;&otilde;es do aviso N&Atilde;O LIBERADO:
           </font>
          </p>
