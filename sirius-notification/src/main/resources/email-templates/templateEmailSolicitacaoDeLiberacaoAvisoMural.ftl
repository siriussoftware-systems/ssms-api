    ...
    <td bgcolor="#ffffff">
      ...
      <tbody>
        ...
        <td>
         ...
         <p> Como o(a) sr(a). &eacute; LIBERADOR(A) do departamento ${departamento}, gostar&iacute;amos de avis&aacute;-lo(a) que um novo aviso necessita de libera&ccedil;&atilde;o para que possa ser publicado no Mural.</strong> </p>
         <p>
           <font color="#B51714" face="Arial, Helvetica, sans-serif">
             E abaixo est&atilde;o sendo enviados um RESUMO das informa&ccedil;&otilde;es do aviso:
           </font>
          </p>
  ...
  <tr>
    ...
    <center>
      ...
      <tr>
        <td width="50%">
          <center>
          <a href="${urlOperacao1}" style="color: green; text-decoration:none; font-size: 20px;"><b>LIBERAR</b></a>
           </center>
        </td>
        <td width="50%">
          <center>
          <a href="${urlOperacao2}" style="color: red; text-decoration:none; font-size: 20px;"><b>N&Atilde;O LIBERAR</b></a>
           </center>
        </td>
      </tr>
    </tbody>
